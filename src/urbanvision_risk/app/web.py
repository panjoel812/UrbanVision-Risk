...
<body>
  <header class="shell">
    ...
    <section class="hero">
      <div>
        <p class="eyebrow">Reliability console · UrbanVision v4.0</p>
  ...
  <footer class="shell"><span>UrbanVision-Risk v4.0 · Reliability + Metrology · Fully local / 完全本地</span></footer>
